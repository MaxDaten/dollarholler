...
<header class="col-span-3 bg-daisyBush text-center">
  <div>
    <a href="/invoices"><img src="/images/logo.svg" alt="Dollar Holler" class="mx-auto" /></a>
  </div>
...
<style lang="postcss">
  ...
  nav ul li a.active {
    ...
    background: url('/images/nav-item/active-nav--left.svg') left top no-repeat,
      url('/images/nav-item/active-nav--right.svg') right top no-repeat;
  }
